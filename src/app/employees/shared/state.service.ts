...
export class StateService {
  // states: AngularFireList<any>;
  constructor(private firebase: AngularFireDatabase, private http: Http) { }

  getStates(): State[] {
    return this._getStatesFromJs();
  }

  private _getStatesFromJs(): State[] {
    return [
      {
        id: '1',
  ...
  private _getCitiesFromHttp(): State[] {
    let statesDb: State[];
    const url = 'https://raw.githubusercontent.com/delrotf/employee-data-management/initial-mods/states-min.json';
    this.http.get(url)
      .subscribe(item => {
